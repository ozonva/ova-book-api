...
// Source: github.com/ozonva/ova-book-api/internals/repo (interfaces: Repo)
...
import (
	...
	book "github.com/ozonva/ova-book-api/internals/entities/book"
)
...
func (m *MockRepo) AddEntities(arg0 []book.Book) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]book.Book, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) UpdateEntity(arg0 string, arg1 book.Book) (*book.Book, error) {
	m.ctrl.T.Helper()
